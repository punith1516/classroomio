...
RUN pnpm build --filter=dashboard -- --timeout 1800000
...
ENV IS_SELFHOSTED=true
ENV DEPLOYMENT_PROVIDER=docker
ENV PUBLIC_SUPABASE_URL=https://grwxlozdvykfknrtrqwq.supabase.co
ENV PUBLIC_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imdyd3hsb3pkdnlrZmtucnRycXdxIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDU4MzQ1NDksImV4cCI6MjA2MTQxMDU0OX0.FpoO6CEwr7h2jgcOHwYaLSo7a9b6usrX0lFKcdzpY_k
ENV PRIVATE_SUPABASE_SERVICE_ROLE=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imdyd3hsb3pkdnlrZmtucnRycXdxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTgzNDU0OSwiZXhwIjoyMDYxNDEwNTQ5fQ.M4uJnCatvMFyq9PcMBxbDlK4Kt11aRCbbLTHx5cFjHI
ENV PRIVATE_APP_HOST=#
ENV PRIVATE_APP_SUBDOMAINS=#
ENV UNSPLASH_API_KEY=#
ENV OPENAI_API_KEY=#
ENV PUBLIC_SERVER_URL=#
ENV PUBLIC_IP_REGISTRY_KEY=#
ENV NODE_OPTIONS="--max-old-space-size=40960"
